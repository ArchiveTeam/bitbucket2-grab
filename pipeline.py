...
LUA_SHA1 = get_hash(os.path.join(CWD, 'bitbucket2.lua'))
    ...
    def realize(self, item):
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            if item_type == 'repo-disco':
                ...
                url = 'https://bitbucket.org/' + item_value
                wget_args.extend(['--warc-header', 'bitbucket-zip: {}'+url])
                wget_args.append(url)
            #elif item_type == 'repo':
            #elif item_type == 'asset':
            #    url = 'https://' + item_value
            #    wget_args.extend(['--warc-header', 'bitbucket-asset: '+url])
            #    wget_args.append(url)
            else:
...
project = Project(
    title=TRACKER_ID,
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/thumb/e/eb/Bitbucket-icon.png/664px-Bitbucket-icon.png" height="50px" title=""/>
        <h2>Bitbucket <span class="links"><a href="https://bitbucket.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/bitbucket2/">Leaderboard</a> &middot; <a href="https://wiki.archiveteam.org/index.php/Bitbucket">Wiki</a></span></h2>
        <p>Archiving Bitbucket.</p>
    '''
)
